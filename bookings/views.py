...
class BookingViewSet(AuditMixin, viewsets.ModelViewSet):
    ...
    def calculate(self, request):
        ...
        response_data = {
            ...
            'base_price_idr': price_details['subtotal_idr'],
            'add_ons_price_idr': price_details['addons_total_idr'],
            'delivery_price_idr': price_details['delivery_price_idr'],
            'discount_amount_idr': price_details['discount_idr'],
            'markup_amount_idr': price_details['markup_idr'],
            'total_price_idr': price_details['total_idr'],
