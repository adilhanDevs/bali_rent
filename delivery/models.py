...
class DeliveryZone(models.Model):
    ...
    polygon = models.JSONField(blank=True, null=True, help_text='List of points: [{"lat": ..., "lng": ...}, ...]')
    ...
    def save(self, *args, **kwargs):
        if self.polygon and not self.polygon_json:
            self.polygon_json = self.polygon
        elif self.polygon_json and not self.polygon:
            self.polygon = self.polygon_json
        self.free_delivery = self.is_free
